...
var commands = {
	...
	"facebook": {
		process: function(bot,msg){
				bot.sendMessage(msg.channel,"**Liked uns auf Facebook!** https://www.facebook.com/wolfspaktcrew/")
				}
	},
	"instagram": {
		process: function(bot,msg){
				bot.sendMessage(msg.channel,"**Folgt uns auf Instagram:** http://www.instagram.com/wolfspaktcrew")
				}
	},
	"twitch": {
		process: function(bot,msg){
				bot.sendMessage(msg.channel,"**Folgt uns auf Twitch! Ob der Stream online ist, könnt ihr mit *!online* überprüfen!** https://www.twitch.tv/wolfspaktcrew")
				}
	},
